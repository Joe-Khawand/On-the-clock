...
mesh create_arrow_mesh(float h)
{
    ...
    m.position[1]=vec3{0,0,h};
    m.position[2]=vec3{5.0,0,0};
    m.position[3]=vec3{5.0,0,h};
    m.position[4]=vec3{4.0,-1.0,0};
    m.position[5]=vec3{4.0,-1.0,h};
    m.position[6]=vec3{4.0+(std::sqrt(2))/2.0,-1.0-(std::sqrt(2.0))/2.0,0};
    m.position[7]=vec3{4.0+(std::sqrt(2))/2.0,-1.0-(std::sqrt(2.0))/2.0,h};
    m.position[8]=vec3{7.0,0.5,0};
    m.position[9]=vec3{7.0,0.5,h};
    m.position[10]=vec3{4.0+(std::sqrt(2))/2.0,2.0+(std::sqrt(2.0))/2.0,0};
    m.position[11]=vec3{4.0+(std::sqrt(2))/2.0,2.0+(std::sqrt(2.0))/2.0,h};
    m.position[12]=vec3{4.0,2.0,0};
    m.position[13]=vec3{4.0,2.0,h};
    m.position[14]=vec3{5.0,1.0,0};
    m.position[15]=vec3{5.0,1.0,h};
    m.position[16]=vec3{0,1.0,0};
    m.position[17]=vec3{0,1.0,h};
